...
- **Version 0.2** 
  ...
  3. Upgrade considerations with running local MariaDB:
        * Find App settings in App service by [Azure Potal](https://portal.azure.com/)
        * Add **DATABASE_TYPE** with value **local**